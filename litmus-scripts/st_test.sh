...
release_ts &
wait
st-job-stats -s *.bin > gedf_$1_$2_$3_$4_$5
...
release_ts &
wait
st-job-stats -s *.bin > cgedf_$1_$2_$3_$4_$5
...
release_ts &
wait
st-job-stats -s *.bin > gfp_$1_$2_$3_$4_$5
...
release_ts &
wait
st-job-stats -s *.bin > cgfp_$1_$2_$3_$4_$5
